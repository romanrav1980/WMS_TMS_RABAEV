...
def main() -> None:
    ...
    try:
        gateway.execute(
            ...
            {"ware_id": WARE_ID, "name": "SMOKE 022 HTTP MAP ROUTE", "prefix": "H22"},
        )
        draft = post_json(
            "/api/admin/warehouse-map-drafts",
            {
                "draft_name": "Smoke 022 HTTP route draft",
        ...
        route = post_json(
            f"/api/admin/warehouse-map-drafts/{draft_id}/route/build",
            {
                ...
                "route_code": "SMOKE-022-HTTP-PICK",
                "route_name": "Smoke 022 HTTP route",
        ...
        saved = post_json(
            ...
            {
                "ware_id": WARE_ID,
                "canvas_code": "SMOKE-022-HTTP-CANVAS",
                "canvas_name": "Smoke 022 HTTP canvas",
                "camera_code": "SMOKE-022-HTTP-MAIN",
                "camera_name": "Smoke 022 HTTP main camera",
                "updated_by": CREATED_BY,
            },
        )
        projection = post_json(
            ...
            {
                "ware_id": WARE_ID,
                "topology_code": "SMOKE-022-HTTP-TOPO",
                "topology_name": "Smoke 022 HTTP topology",
                "updated_by": CREATED_BY,
            },
        )
