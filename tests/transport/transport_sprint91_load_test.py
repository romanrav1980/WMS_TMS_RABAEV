"""
transport_sprint91_load_test.py — Load test for Sprint 91 (sort trip STs by time window).

Sort is pure frontend — no new backend endpoints.
We test the /tasks/{id}/sts endpoint at selection-time load.
