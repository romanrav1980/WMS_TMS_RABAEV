"""
transport_sprint92_load_test.py — Load test for Sprint 92 (copy ST numbers to clipboard).

Copy is pure frontend — no new backend endpoints.
We test the /tasks/{id}/sts endpoint (loads ST list for clipboard copy).
