...
| # | Название | Блок | Оценка | Статус |
|---|---------|------|--------|--------|
| 1 | Таблица заявок и фильтры | Диспетчер | 1 нед | ✅ частично (Phase 2.1) |
| 2 | Выделение СТ и создание рейса | Диспетчер | 1 нед | ⬜ |
| 3 | Вкладка «Маршруты»: список и состав | Диспетчер | 1 нед | ⬜ |
| 4 | Редактирование и закрытие рейса | Диспетчер | 1 нед | ⬜ |
| 5 | Прогресс сборки и требования ТС | Диспетчер | 1 нед | ⬜ |
| 6 | Тонкое редактирование и вкладка «Паллеты» | Диспетчер | 1 нед | ⬜ |
| 7 | Карта заказов (OSM + маркеры) | MAP | 1 нед | ⬜ |
| 8 | Матрица расстояний + VRP-оптимизатор | MAP | 1.5 нед | ⬜ |
| 9 | Визуальный полигон, кластеры, шаблоны | MAP | 1 нед | ⬜ |
| 10 | Аналитика плана и качество оптимизации | MAP | 1 нед | ⬜ |
| 11 | Модель операций и нормативы (база ARM) | ARM | 1 нед | ⬜ |
| 12 | Диаграмма Ганта | ARM | 1.5 нед | ⬜ |
| 13 | Умный подбор машины и конфликты | ARM | 1 нед | ⬜ |
| 14 | План-фактный анализ | ARM | 1 нед | ⬜ |
| 15 | Биллинг: создание счёта | Billing | 1 нед | ⬜ |
| 16 | Биллинг: закрытие и оплата | Billing | 1 нед | ⬜ |
| 17 | Биллинг: реестр счетов | Billing | 1 нед | ⬜ |
| **Итого** | | | **~17 нед** | |
