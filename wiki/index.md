...
- [requirements/warehouse_topology_pick_route_tz.md](requirements/warehouse_topology_pick_route_tz.md): Russian technical assignment for warehouse topology and pick-route administration as rare versioned master-data processes, with graphical generation, route publishing, recommendations, PL/SQL/API contracts, and digital-twin integration
