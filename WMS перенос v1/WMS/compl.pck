...
begin
    ...
    select DEV_ORDERS_BY_PALL_AUTO into flag_DEV_ORDERS_BY_PALL_AUTO from rrl_wares where id=ware_id6;
           ...
           for orow in order_rows loop
               ...
               if( orow.quantity_planned=0 ) then
                   begin
                      ...
                      --  null;
                    update rrl_sborka_pallet_rows  set quantity=0, ORDER_WEIGHT=0,  PACK_COUNT=0 where pallet_uid=puid1 and articul=orow.articul;   
