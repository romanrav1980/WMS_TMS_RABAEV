...
DECLARE
  -- ── Переменные и типы — ПЕРВЫМИ (требование Oracle PL/SQL) ───────────────

  v_ware_prefix  VARCHAR2(10);
  v_ware_id      NUMBER;
  v_cell         VARCHAR2(30);
  v_artcode      VARCHAR2(40);
  v_art_global   NUMBER := 0;
  ...
  -- ── Вспомогательные процедуры — ПОСЛЕ переменных ─────────────────────────
...
BEGIN
  ...
  -- 1. СКЛАДЫ
  -- ──────────────────────────────────────────────────────────────────────────
  upsert_ware(9201, 'ДЦ-Пермь (Добра Цен)',         'DCP', 201);
  upsert_ware(9202, 'ДЦ-Екатеринбург (Добра Цен)',  'DCE', 202);
  upsert_ware(9203, 'ДЦ-Тюмень (Добра Цен)',        'DCT', 203);
