-- =============================================================================
-- Migration 043 — Transport Dispatch Improvements
-- =============================================================================
-- Обновляет RRL_V_AVAILABLE_STS: добавляет VERIFY_PERC и NAPR.
-- VERIFY_PERC — процент сборки СТ (из RABAEV.RRL_ST_VERYFY_PERC).
-- NAPR        — направление из RRL_SBORKA_PALLETS.NAPR.
-- Применяется поверх 042. Безопасно повторно: CREATE OR REPLACE VIEW.
-- =============================================================================
