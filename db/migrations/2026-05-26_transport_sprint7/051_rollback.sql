-- =============================================================================
-- Rollback 051 — Transport Sprint 7
-- =============================================================================

DROP TABLE RABAEV.RRL_ADDR_DISTANCE_MATRIX;
DROP TABLE RABAEV.RRL_PLANNER_PLANS;
DROP SEQUENCE RABAEV.SEQ_PLANNER_PLANS;

-- Возврат вьюхи к версии 048
CREATE OR REPLACE VIEW RABAEV.RRL_V_AVAILABLE_STS AS
SELECT
  P.ST_NUMBER, P.ADDR,
  NVL(A.REGION, P.ADDR) AS REGION,
  A.RAION, A.ORD, A.SHIROTA, A.DOLGOTA,
...
GROUP BY
  ...
  A.SHIROTA, A.DOLGOTA, P.WARE_ID, A.TRANSPORT_TYPE, A.STOL, A.PRIM1;
