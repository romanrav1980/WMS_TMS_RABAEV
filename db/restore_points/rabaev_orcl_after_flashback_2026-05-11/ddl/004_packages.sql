...
prompt PACKAGE ARTICULS

  CREATE OR REPLACE EDITIONABLE PACKAGE "RABAEV"."ARTICULS" is
...
prompt PACKAGE COMPL

  CREATE OR REPLACE EDITIONABLE PACKAGE "RABAEV"."COMPL" is
...
prompt PACKAGE CROSS_DOCKING

  CREATE OR REPLACE EDITIONABLE PACKAGE "RABAEV"."CROSS_DOCKING" is
...
prompt PACKAGE DOCK_PLANNING

  CREATE OR REPLACE EDITIONABLE PACKAGE "RABAEV"."DOCK_PLANNING" is
...
prompt PACKAGE GOODS_TO_PICK

  CREATE OR REPLACE EDITIONABLE PACKAGE "RABAEV"."GOODS_TO_PICK" is
...
prompt PACKAGE ORDERS

  CREATE OR REPLACE EDITIONABLE PACKAGE "RABAEV"."ORDERS" is
...
prompt PACKAGE PK_PIVOT

  CREATE OR REPLACE EDITIONABLE PACKAGE "RABAEV"."PK_PIVOT" pk_pivot
--AUTHID CURRENT_USER
as
...
prompt PACKAGE REMAINS

  CREATE OR REPLACE EDITIONABLE PACKAGE "RABAEV"."REMAINS" is
...
prompt PACKAGE REVIZION

  CREATE OR REPLACE EDITIONABLE PACKAGE "RABAEV"."REVIZION" is

  -- Author  : RRABAEV
  -- Created : 15.06.2011 10:04:49
  -- Purpose : РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…
...
prompt PACKAGE TRANSPORT_TASK

  CREATE OR REPLACE EDITIONABLE PACKAGE "RABAEV"."TRANSPORT_TASK" is
