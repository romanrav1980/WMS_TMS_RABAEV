...
prompt FUNCTION ADD_HISTORY_NOTE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."ADD_HISTORY_NOTE" (
...
prompt FUNCTION ADD_RRL_OTHOD_NAKLAD

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."ADD_RRL_OTHOD_NAKLAD" (
...
prompt FUNCTION ADD_RRL_OTHOD_NAKLAD_ROWS

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."ADD_RRL_OTHOD_NAKLAD_ROWS" (
ID_ROW1 int ,
    ID_NAKLAD1           int      ,
    ARTICUL1 varchar,
    COUNT2  number
...
prompt FUNCTION ADD_RRL_PRIH_NAKLAD

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."ADD_RRL_PRIH_NAKLAD" (
...
prompt FUNCTION ADD_RRL_PRIH_NAKLAD_ROW

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."ADD_RRL_PRIH_NAKLAD_ROW" (
    NAKLAD_ID int,
    articul string,
    expiury_date date ,
    count1 NUMBER ,
...
prompt FUNCTION ADD_RRL_PRIH_NAKLAD_ROW2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."ADD_RRL_PRIH_NAKLAD_ROW2" (
    NAKLAD_ID int,
    articul1 varchar2,
    expiury_date date ,
    count1 NUMBER ,
...
prompt FUNCTION ADD_RRL_PRIH_NAKLAD2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."ADD_RRL_PRIH_NAKLAD2" (
...
prompt FUNCTION ADD_RRL_TR_VEHICLE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."ADD_RRL_TR_VEHICLE" (
  ID1 int ,
  NUM1 varchar2 , 
  TR_TYPE1 varchar2 , 
  MARKA1  varchar2 ,
...
prompt FUNCTION ADD_RRL_VOD

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."ADD_RRL_VOD" (
 ID1              INTEGER   ,
  F1               VARCHAR2 ,
  I1               VARCHAR2 ,
  O1               VARCHAR2 ,
...
prompt FUNCTION ADD_SFERA_EAN2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."ADD_SFERA_EAN2" (
    TMC_UID in varchar2,
    EAN_SHT varchar2,
    EAN_BL varchar2,
    EAN_KOR varchar2,
...
prompt FUNCTION CALC_TIMESTAMP_DIFF_IN_SECONDS

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."CALC_TIMESTAMP_DIFF_IN_SECONDS" (ts1 in timestamp, ts2 in timestamp)
...
prompt FUNCTION DELETE_RRL_PRIH_NAKLAD_ROW

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."DELETE_RRL_PRIH_NAKLAD_ROW" (
    ROW_ID1 int
) return varchar2
IS
order_id2 int;
...
prompt FUNCTION FTIME_SHIPPING_PLAN

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."FTIME_SHIPPING_PLAN" ( 
STDATE date ,
...
prompt FUNCTION INT2BOOL

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."INT2BOOL" ( 
par int
 )
 RETURN varchar2 
 IS 
...
prompt FUNCTION ISIF

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."ISIF" ( 
par1 int ,
par2 int 
 )
 RETURN int 
...
prompt FUNCTION MIN2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."MIN2" (
par1 number ,
par2 number
 )
 RETURN number 
...
prompt FUNCTION OBJ2NUMBER

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."OBJ2NUMBER" ( 
par1 number 
 )
 RETURN number 
 IS 
...
prompt FUNCTION RRL_ABC_CALCULATE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_ABC_CALCULATE" ( ware_id1 int  )
    RETURN int IS 
    tmpVar varchar2(255);
    ABC_A1 number;
    ABC_B1 number;
...
prompt FUNCTION RRL_ACCEPT_ORDER

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_ACCEPT_ORDER" ( order_id int )
...
prompt FUNCTION RRL_ACCEPT_ORDER2_3

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_ACCEPT_ORDER2_3" (
 order_id int ,
 user_id1 varchar2
 ) return int
is
...
prompt FUNCTION RRL_ADD_INV_LINE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_ADD_INV_LINE" RRL_ADD_INV_LINE
(
...
prompt FUNCTION RRL_ADD_TT_2_BILLINGORDER

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_ADD_TT_2_BILLINGORDER" ( 
bill_id int ,
tt_id int ,
...
prompt FUNCTION RRL_AUTH

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_AUTH" RRL_AUTH
(
    login varchar2 , 
    pass1 varchar2
)
...
prompt FUNCTION RRL_AUTH2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_AUTH2" RRL_AUTH2
(
    login varchar2 , 
    pass1 varchar2 ,
    version1 varchar2 
...
prompt FUNCTION RRL_AUTH3

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_AUTH3" RRL_AUTH3
(
    login varchar2 , 
    pass1 varchar2 ,
    version1 varchar2 ,
...
prompt FUNCTION RRL_BILL_ADD_TTBILL

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_BILL_ADD_TTBILL" RRL_BILL_ADD_TTBILL
(
   ID1 int,
   NUM1 varchar2,
   COMPANY1 varchar2,
...
prompt FUNCTION RRL_BILLINGORDER_SUM

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_BILLINGORDER_SUM" ( 
bill_id int 
)
...
prompt FUNCTION RRL_CARTON_WEIGHT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_CARTON_WEIGHT" (
    ART varchar2  ,
    count1 int
) return int
-- КОЛИЧЕСТВО КОРОБОК 
...
prompt FUNCTION RRL_CARTON_WEIGHT2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_CARTON_WEIGHT2" 
(
    ART varchar2  ,
    count1 int ,
    CURRENT_MOD_ID2 int
...
prompt FUNCTION RRL_CLEAR_OTBOR_CELL

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_CLEAR_OTBOR_CELL" (
    CELL1 varchar2 ,
    user_id1 varchar2
)
 RETURN varchar2 IS
...
prompt FUNCTION RRL_CLEAR_OTHOD_NAKLAD2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_CLEAR_OTHOD_NAKLAD2" (
    ID_NAKLAD1           int 
)
 RETURN INT 
 IS
...
prompt FUNCTION RRL_CLEAR_PRIH_NAKLAD_ROWS

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_CLEAR_PRIH_NAKLAD_ROWS" (
    NAKLAD_ID int
) return int
IS
ID2 int;
...
prompt FUNCTION RRL_CLOSE_BILLINGORDER

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_CLOSE_BILLINGORDER" ( 
bill_id int ,
...
prompt FUNCTION RRL_CLOSE_OTHOD_NAKLAD

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_CLOSE_OTHOD_NAKLAD" RRL_CLOSE_OTHOD_NAKLAD
...
prompt FUNCTION RRL_CLOSE_OTHOD_PALLET

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_CLOSE_OTHOD_PALLET" RRL_CLOSE_OTHOD_PALLET
 -- ЗАКРЫВАЕТ ОТГРУЗОЧНУЮ НАКЛАДНУЮ 
(
    PALLET_ID1 varchar2 ,
    iser_id21 varchar2 
...
prompt FUNCTION RRL_COPY_PALLET_ROW2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_COPY_PALLET_ROW2" ( 
    row_id2 int ,
    count1  number , 
...
prompt FUNCTION RRL_COUNT_KOR

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_COUNT_KOR" (
    ART varchar2  ,
    count1 int
) return int
-- КОЛИЧЕСТВО КОРОБОК 
...
prompt FUNCTION RRL_COUNT_KOR2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_COUNT_KOR2" (
    ART varchar2  ,
    count1 int ,
     CURRENT_MOD_ID2 int
) return int
...
prompt FUNCTION RRL_COUNT_KOR3

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_COUNT_KOR3" (
    ART varchar2  ,
    count1 int ,
...
prompt FUNCTION RRL_COUNT_KOR4

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_COUNT_KOR4" (
    count1 int ,
    pallet_uid1 varchar2
) return int
-- Определение количества коробок на основании прихода. 
...
prompt FUNCTION RRL_DAY_DISTRIBUTE_ENDS

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_DAY_DISTRIBUTE_ENDS" RRL_DAY_DISTRIBUTE_ENDS
(
    articul1 varchar2 ,
    exp_date1 date 
...
prompt FUNCTION RRL_DELETE_CELL

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_DELETE_CELL" (
cell4 varchar2 
)
 RETURN NUMBER IS
tmpVar varchar2(250);
...
prompt FUNCTION RRL_DELETE_OPALLET

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_DELETE_OPALLET" (
    PALLET_ID1 varchar2 
)
 RETURN varchar2 IS
...
prompt FUNCTION RRL_DELETE_OP2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_DELETE_OP2" (
  PUID1 varchar2,
  user_id1 varchar2
)
return varchar2
...
prompt FUNCTION RRL_DELETE_ST

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_DELETE_ST" (
ST_NUMBER1 varchar2 
)
 RETURN varchar2 IS
tmpVar varchar2(250);
...
prompt FUNCTION RRL_GET_CELL_REMAIN

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GET_CELL_REMAIN" ( cell_id varchar2 )
 RETURN NUMBER IS 
tmpVar NUMBER;
BEGIN
   tmpVar := 0;
...
prompt FUNCTION RRL_GET_MOD_INFO

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GET_MOD_INFO" ( mod_id int )
 RETURN varchar2 IS 
tmpVar varchar2(255);
BEGIN
   tmpVar := '';
...
prompt FUNCTION RRL_GET_PAL_INFOTEXT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GET_PAL_INFOTEXT" (
    PALLET_UID1 varchar2  
) return varchar2
IS
...
prompt FUNCTION RRL_GET_PALLET_CHECK_TIMES

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GET_PALLET_CHECK_TIMES" ( puid varchar2 )
 RETURN varchar2 IS 
...
prompt FUNCTION RRL_GET_PALLET_ROWS_COUNT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GET_PALLET_ROWS_COUNT" ( puid varchar2 )
 RETURN int IS 
...
prompt FUNCTION RRL_GET_SBORKA_PALLET_TIME

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GET_SBORKA_PALLET_TIME" 
 ( puid varchar2 )
 RETURN DATE  IS 
 tmp date;
BEGIN
...
prompt FUNCTION RRL_GET_ST_CHECK_TIMES

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GET_ST_CHECK_TIMES" ( st_id varchar2 )
 RETURN varchar2 IS 
tmpVar varchar2(1024);
...
prompt FUNCTION RRL_GET_ST_IS_SCANNED

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GET_ST_IS_SCANNED" ( st_number1 varchar2 )
 RETURN number IS 
tmpVar number;
itogo number ;
ret number ;
...
prompt FUNCTION RRL_GET_TT_INFO

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GET_TT_INFO" ( tt_id int )
 RETURN varchar2 IS 
tmpVar varchar2(255);
BEGIN
   tmpVar := 'пусто';
...
prompt FUNCTION RRL_GET_TT_PRICE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GET_TT_PRICE" 
 ( tt_id int )
 RETURN number IS 
...
prompt FUNCTION RRL_GET_TT_PRICE_ID

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GET_TT_PRICE_ID" 
 ( tt_id int )
 RETURN varchar2 IS 
tmpVar varchar2(1024);
...
prompt FUNCTION RRL_GET_TT_PRICE_ID2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GET_TT_PRICE_ID2" 
 ( tt_id int )
 RETURN varchar2 IS 
tmpVar varchar2(1024);
...
prompt FUNCTION RRL_GET_USER_INFO

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GET_USER_INFO" ( USER_ID1 varchar2 )
...
prompt FUNCTION RRL_GIVE_DESTINATION_CELL2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GIVE_DESTINATION_CELL2" (
...
prompt FUNCTION RRL_GIVE_KARSH_STAT_INFO

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GIVE_KARSH_STAT_INFO" ( 
user_id1 varchar2 )
 RETURN varchar2 IS 
tmpVar varchar2(255);
BEGIN
...
prompt FUNCTION RRL_GIVE_NEXT_CELL

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GIVE_NEXT_CELL" RRL_GIVE_NEXT_CELL
(
    cell1 varchar2
)
 RETURN varchar2
...
prompt FUNCTION RRL_GIVE_NEXT_OPALLET_NUMBER

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GIVE_NEXT_OPALLET_NUMBER" RRL_GIVE_NEXT_OPALLET_NUMBER
(
...
prompt FUNCTION RRL_GIVE_POPOLNENIE2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GIVE_POPOLNENIE2" 
(
...
prompt FUNCTION RRL_GIVE_PREVIOUS_CELL

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GIVE_PREVIOUS_CELL" RRL_GIVE_PREVIOUS_CELL
(
    cell1 varchar2
)
...
prompt FUNCTION RRL_GIVE_TERMINAL_TASK

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GIVE_TERMINAL_TASK" ( USER_ID1 varchar2 )
RETURN varchar2 
IS 
    tmp varchar2(255);
BEGIN
...
prompt FUNCTION RRL_GIVE_TERMINAL_TASK2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_GIVE_TERMINAL_TASK2" (
    USER_ID1 varchar2 ,
    ip_addr1 varchar2
 )
RETURN varchar2 
...
prompt FUNCTION RRL_HAS_WRIGHT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_HAS_WRIGHT" ( user_id varchar2 , wright_name varchar2 )
    RETURN int IS 
    tmpVar varchar2(255);
...
prompt FUNCTION RRL_INFO_CELL_RESTS

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_INFO_CELL_RESTS" RRL_INFO_CELL_RESTS
(
    cell1 varchar2 
)
...
prompt FUNCTION RRL_INFO_PALLET_RESTS

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_INFO_PALLET_RESTS" RRL_INFO_PALLET_RESTS
(
    pallet_id varchar2 
)
...
prompt FUNCTION RRL_INTERNAL_MOVE2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_INTERNAL_MOVE2" (
pallet_id varchar2 , 
cell_to varchar2 ,
count1 number ,
user_id1 varchar2
...
prompt FUNCTION RRL_INTERNAL_MOVE3

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_INTERNAL_MOVE3" (
pallet_id varchar2 , 
cell_to varchar2 ,
count1 number ,
user_id1 varchar2
...
prompt FUNCTION RRL_INV_CREATE_LINE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_INV_CREATE_LINE" RRL_INV_CREATE_LINE
( 
    cell1 varchar2 ,
    shk_art varchar2 , 
...
prompt FUNCTION RRL_INV_CREATE_LINE2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_INV_CREATE_LINE2" RRL_INV_CREATE_LINE2
( 
    cell1 varchar2 ,
    shk_art varchar2 , 
    articul_part varchar2,
...
prompt FUNCTION RRL_INV_CREATE_LINE3

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_INV_CREATE_LINE3" RRL_INV_CREATE_LINE3
( 
    cell1 varchar2 ,
    shk_art varchar2 , 
    articul_part varchar2,
...
prompt FUNCTION RRL_INV_CREATE_LINE4

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_INV_CREATE_LINE4" RRL_INV_CREATE_LINE4
( 
    cell1 varchar2 ,
    shk_art varchar2 , 
    articul_part varchar2,
...
prompt FUNCTION RRL_IS_PALLET_LIKE_FAKE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_IS_PALLET_LIKE_FAKE" ( puid varchar2 )
 RETURN int IS 
tmpVar int;
...
prompt FUNCTION RRL_IS_PALLET_STRICTLY_FAKE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_IS_PALLET_STRICTLY_FAKE" ( puid varchar2 )
...
prompt FUNCTION RRL_MAY_DELETE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_MAY_DELETE" ( ST_N varchar2 )
 RETURN varchar2 IS 
tmpVar varchar2(6);
t2 int;
...
prompt FUNCTION RRL_MAY_DISTRIBUTE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_MAY_DISTRIBUTE" RRL_MAY_DISTRIBUTE
(
    articul1 varchar2 ,
    exp_date1 date
)
...
prompt FUNCTION RRL_OP_WEIGHT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_OP_WEIGHT" ( PALLET_UID1 varchar2 )
 RETURN number IS 
tmpVar number;
...
prompt FUNCTION RRL_OP_WEIGHT2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_OP_WEIGHT2" ( PALLET_UID1 varchar2 )
 RETURN number IS 
tmpVar number;
...
prompt FUNCTION RRL_OTHOD_PALLET_PODBOR_PARTII

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_OTHOD_PALLET_PODBOR_PARTII" (
  PALLET_ID1 varchar2
) return varchar2
is
  tmpVar int;
...
prompt FUNCTION RRL_PAL_KOR_COUNT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PAL_KOR_COUNT" ( PALID varchar2 )
 RETURN number IS 
tmpVar number;
BEGIN
   tmpVar := 0;
...
prompt FUNCTION RRL_PALLET_HAS_MODS

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PALLET_HAS_MODS" (
    PALLET_UID1  varchar2 
 )
...
prompt FUNCTION RRL_PALLET_WEIGHT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PALLET_WEIGHT" (PALID varchar2  )
 RETURN number IS 
tmpVar number;
itogo int;
sobrano int;
...
prompt FUNCTION RRL_PALLET_WEIGHT_SET

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PALLET_WEIGHT_SET" (
    PALLET_UID1  varchar2 ,
...
prompt FUNCTION RRL_PALLET_WEIGHT2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PALLET_WEIGHT2" (
    PALLET_UID1  varchar2 
 )
...
prompt FUNCTION RRL_PAL_ROW_COUNT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PAL_ROW_COUNT" ( PALID varchar2 )
 RETURN number IS 
tmpVar number;
BEGIN
   tmpVar := 0;
...
prompt FUNCTION RRL_PAL_VOLUME

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PAL_VOLUME" ( PALID varchar2 )
 RETURN number IS 
tmpVar number;
BEGIN
   tmpVar := 0;
...
prompt FUNCTION RRL_PAL_WEIGHT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PAL_WEIGHT" ( PALID varchar2 )
 RETURN number IS 
tmpVar number;
BEGIN
   tmpVar := 0;
...
prompt FUNCTION RRL_PAY_BILLINGORDER

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PAY_BILLINGORDER" ( 
bill_id int ,
act int -- 0 ОТкрыть 1  Закрыть
)
...
prompt FUNCTION RRL_PRIEMPALLET_HEIGHT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PRIEMPALLET_HEIGHT" ( pallet_uid varchar2 , count_of number )
 RETURN number IS 
WEIGHT1 number;
itogo int;
sobrano int;
...
prompt FUNCTION RRL_PRIEMPALLET_WEIGHT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PRIEMPALLET_WEIGHT" ( pallet_uid varchar2 , count_of number )
 RETURN number IS 
WEIGHT1 number;
itogo int;
sobrano int;
...
prompt FUNCTION RRL_PRIHOD_MAY_STORNO

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PRIHOD_MAY_STORNO" (
    order_id1  int 
 )
...
prompt FUNCTION RRL_PRIHODPALLET_CALC_COUNT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PRIHODPALLET_CALC_COUNT" (
PALLET_UID1 varchar2 , 
weight1 number ,
...
prompt FUNCTION RRL_PRIHODPALLET_CALC_WEIGHT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PRIHODPALLET_CALC_WEIGHT" (
PALLET_UID1 varchar2 , 
COUNT1 number ,
...
prompt FUNCTION RRL_PRIHODPALLET_CHANGE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PRIHODPALLET_CHANGE" (
 PALLET_UID1 varchar2 , 
 art varchar2 ,
 UNIT_COUNT1  number ,
 DEFECT_PERC1  number ,
...
prompt FUNCTION RRL_PRIHODPALLET_CHANGE_COUNT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PRIHODPALLET_CHANGE_COUNT" (
PALLET_UID1 varchar2 , 
count1 number  ,
...
prompt FUNCTION RRL_PRIHODPALLET_CHANGE_WEIGHT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PRIHODPALLET_CHANGE_WEIGHT" (
PALLET_UID1 varchar2 , 
weight_brutto1 number  ,
...
prompt FUNCTION RRL_PRIHOD_VERIFY

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_PRIHOD_VERIFY" (
 prihod_id1 int 
  ) 
...
prompt FUNCTION RRL_REVIZION_CELL

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_REVIZION_CELL" 
...
prompt FUNCTION RRL_REVIZION_CELL_KOR

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_REVIZION_CELL_KOR" 
(
    CELL1 varchar2 ,
    count_kor2 varchar2 ,
    user_id1 varchar2
...
prompt FUNCTION RRL_SBORKA_CELL

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SBORKA_CELL" ( 
articul1 varchar2 ,
ware_id int , 
count1 number ,
addr1 varchar2
...
prompt FUNCTION RRL_SBORKA_PALLET_ROWS_ADD

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SBORKA_PALLET_ROWS_ADD" (
...
prompt FUNCTION RRL_SBORKA_PALLET_ROWS_ADD2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SBORKA_PALLET_ROWS_ADD2" (
  PALLET_UID1    VARCHAR2,
  ARTICUL1       VARCHAR2,
  SHORTNAME1     VARCHAR2,
  SHTRIHKOD1     VARCHAR2,
...
prompt FUNCTION RRL_SBORKA_PALLET_ROWS_ADD3

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SBORKA_PALLET_ROWS_ADD3" (
...
prompt FUNCTION RRL_SBORKA_PALLET_ROWS_ADD4

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SBORKA_PALLET_ROWS_ADD4" (
...
prompt FUNCTION RRL_SBORKA_PALLETS_ADD

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SBORKA_PALLETS_ADD" (
    ST_NUMBER1   varchar2,
    ADDR1 varchar2,
...
prompt FUNCTION RRL_SBORKA_PALLETS_ADD2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SBORKA_PALLETS_ADD2" (
    ST_NUMBER1   varchar2,
    ADDR1 varchar2,
    PALLET_NUMBER1 INTEGER ,
    PALLET_UID1     VARCHAR2 ,
...
prompt FUNCTION RRL_SBORKA_PLANNINGTIME

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SBORKA_PLANNINGTIME" ( pall_id1 varchar2 )
 RETURN Date IS 
tmpVar Date;
...
prompt FUNCTION RRL_SET_KLADOVSHIK

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SET_KLADOVSHIK" (
    PALLET_UID1 varchar2  ,
...
prompt FUNCTION RRL_SET_SBORKA_ZONE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SET_SBORKA_ZONE" (
    PALLET_UID1 varchar2  ,
    ZONE1 varchar2 ,
    user_id1 varchar2
) return int
...
prompt FUNCTION RRL_SET_SBORSHIK

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SET_SBORSHIK" (
    PALLET_UID1 varchar2  ,
    SBORSHIK1 varchar2
) return int
...
prompt FUNCTION RRL_SET_SCAN_PROOVE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SET_SCAN_PROOVE" (
    PALLET_UID1 varchar2  ,
...
prompt FUNCTION RRL_SET_SCAN_PROOVE2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SET_SCAN_PROOVE2" (
    PALLET_UID1 varchar2  ,
    count_of_errors1 int ,
    prim1 varchar2 , 
    SBORSHIK1  VARCHAR2,
...
prompt FUNCTION RRL_SET_TRANSPORT_PRICE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SET_TRANSPORT_PRICE" (
...
prompt FUNCTION RRL_SET_TT_LOAD_TASK

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SET_TT_LOAD_TASK" (
    TT_ID1 int  ,
    ZONE varchar2 , 
    time_from timestamp ,
    time_to timestamp ,
...
prompt FUNCTION RRL_SFERA_EAN_EAN_BL

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SFERA_EAN_EAN_BL" RRL_sfera_ean_EAN_BL
(
    articul varchar2
)
...
prompt FUNCTION RRL_SFERA_EAN_EAN_KOR

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SFERA_EAN_EAN_KOR" RRL_sfera_ean_EAN_KOR
(
    articul varchar2
)
...
prompt FUNCTION RRL_SFERA_EAN_EAN_SHT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SFERA_EAN_EAN_SHT" RRL_sfera_ean_EAN_SHT
(
    articul varchar2
)
...
prompt FUNCTION RRL_SHOW_PRICE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SHOW_PRICE" ( tt_id int )
 RETURN number IS 
tmpVar number;
BEGIN
   tmpVar := 0;
...
prompt FUNCTION RRL_SKLADNAME_BY_ID

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SKLADNAME_BY_ID" ( ids int )
 RETURN varchar2  IS 
tmpVar varchar2(50);
...
prompt FUNCTION RRL_ST_ROW_COUNT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_ST_ROW_COUNT" ( ST varchar2 )
 RETURN number IS 
tmpVar number;
BEGIN
   tmpVar := 0;
...
prompt FUNCTION RRL_ST_UNIQPCOUNT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_ST_UNIQPCOUNT" ( ST varchar2 )
 RETURN int IS 
tmpVar number;
itogo int;
sobrano int;
...
prompt FUNCTION RRL_ST_VERYFY_PERC

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_ST_VERYFY_PERC" ( ST varchar2 )
 RETURN int IS 
tmpVar number;
itogo int;
sobrano int;
...
prompt FUNCTION RRL_ST_VOLUME

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_ST_VOLUME" ( stnumber1 varchar2 )
 RETURN number IS 
tmpVar number;
...
prompt FUNCTION RRL_ST_WEIGHT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_ST_WEIGHT" ( stnumber1 varchar2 )
 RETURN number IS 
tmpVar number;
...
prompt FUNCTION RRL_SUGAR_HAS

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SUGAR_HAS" ( ART varchar2 )
return int
is
BEGIN
...
prompt FUNCTION RRL_SYNC_ADDR

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_SYNC_ADDR" (
dummy int
)
RETURN INT
is
...
prompt FUNCTION RRL_TIME_FOR_RESERV

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TIME_FOR_RESERV" RETURN int IS
...
prompt FUNCTION RRL_TOVAR_TYPE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TOVAR_TYPE" ( ART varchar2 , ware_id1  int  )
 RETURN int IS 
...
prompt FUNCTION RRL_TRANPORT_TASK_HISTORY_ADD

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TRANPORT_TASK_HISTORY_ADD" (
 TT_ID int, 
 TRANSTYPE1 varchar2, 
 TRANSPORT1 varchar2, 
 ROUTETYPE1 varchar2, 
...
prompt FUNCTION RRL_TRASPORT_TASK_ADD

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TRASPORT_TASK_ADD" (
    TRANSTYPE1    VARCHAR2 ,
    SHIPMENT_DATE1 DATE , 
    user_id1 varchar2
) return int
...
prompt FUNCTION RRL_TRASPORT_TASK_UPDATE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TRASPORT_TASK_UPDATE" (
    TT_ID    int ,
    TRANSTYPE1 varchar2 , 
    TRANSPORT1 varchar2 ,
    ROUTETYPE1 varchar2 ,
...
prompt FUNCTION RRL_TRASPORT_TASK_UPDATE2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TRASPORT_TASK_UPDATE2" (
    TT_ID    int ,
    TRANSTYPE1 varchar2 , 
    TRANSPORT1 varchar2 ,
    ROUTETYPE1 varchar2 ,
...
prompt FUNCTION RRL_TRIAL_BY_WEIGHT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TRIAL_BY_WEIGHT" ( 
    PALLET_UID1  varchar2 ,
    TRIAL_WEIGHT1 varchar2 ,
    WOOD_WEIGHT1 varchar2 ,
    user_id1 varchar2
...
prompt FUNCTION RRL_TRIAL_BY_WEIGHT2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TRIAL_BY_WEIGHT2" ( 
    PALLET_UID1  varchar2 ,
    TRIAL_WEIGHT1 varchar2 ,
    WOOD_WEIGHT1 varchar2 ,
    user_id1 varchar2
...
prompt FUNCTION RRL_TT_ADD_PALL

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_ADD_PALL" ( 
    TT_ID int ,
    ST_NUMBER1 varchar2  
)
 RETURN varchar2 IS 
...
prompt FUNCTION RRL_TT_ADDR_COUNT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_ADDR_COUNT" ( TTID int )
 RETURN int IS 
    tmpVar int;
BEGIN
...
prompt FUNCTION RRL_TT_BILL_RECALC_PRICE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_BILL_RECALC_PRICE" RRL_TT_BILL_RECALC_PRICE
(
    login varchar2 
)
 RETURN int
...
prompt FUNCTION RRL_TT_DROP

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_DROP" ( IDTT int )
 RETURN number IS 
tmpVar number;
itogo int;
sobrano int;
...
prompt FUNCTION RRL_TT_DROP2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_DROP2" ( IDTT int , user_id1 varchar2 )
 RETURN number IS 
tmpVar number;
itogo int;
sobrano int;
...
prompt FUNCTION RRL_TT_PALLETS

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_PALLETS" ( IDTT int )
 RETURN number IS 
tmpVar int;
...
prompt FUNCTION RRL_TT_PLAN_DOCK

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_PLAN_DOCK" RRL_TT_PLAN_DOCK
(  
  TT  int ,
  time1 timestamp ,
  ware_id1 int
...
prompt FUNCTION RRL_TT_PLAN_PALL_ZONES

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_PLAN_PALL_ZONES" RRL_TT_PLAN_PALL_ZONES
(  
  TT  int , 
  ZONE1 varchar2 , -- Зона 
...
prompt FUNCTION RRL_TT_PLAN_SHIPPPING_HOUR

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_PLAN_SHIPPPING_HOUR" RRL_TT_PLAN_SHIPPPING_HOUR
( IDTT int )
RETURN timestamp 
IS 
...
prompt FUNCTION RRL_TT_POGRESHNOST

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_POGRESHNOST" ( IDTT int )
 RETURN number IS 
tmpVar number;
...
prompt FUNCTION RRL_TT_POGRESHNOST2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_POGRESHNOST2" ( PALLET_UID1 varchar2 )
 RETURN number IS 
tmpVar number;
count_kor number;
...
prompt FUNCTION RRL_TT_READY_PERC

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_READY_PERC" ( IDTT int )
 RETURN number IS 
tmpVar number;
itogo int;
sobrano int;
...
prompt FUNCTION RRL_TT_REGIONS

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_REGIONS" ( TTID int )
 RETURN varchar2 IS 
tmpVar varchar2(1024);
tmpVar2 varchar2(1024);
cursor ttu is
...
prompt FUNCTION RRL_TT_REORDER_ADR

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_REORDER_ADR" (IDTT int)
 return number
is
  tmpVar number;
...
prompt FUNCTION RRL_TT_SET_TRANSCOMMENT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_SET_TRANSCOMMENT" (
...
prompt FUNCTION RRL_TT_SUMM

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_SUMM" ( IDTT int )
 RETURN number IS 
tmpVar number;
...
prompt FUNCTION RRL_TT_VERYFY_PERC

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_VERYFY_PERC" ( IDTT int )
 RETURN number IS 
tmpVar number;
itogo int;
sobrano int;
...
prompt FUNCTION RRL_TT_VODITEL_COMPANY

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_VODITEL_COMPANY" ( VODITEL_ID1 int )
...
prompt FUNCTION RRL_TT_VODITEL_INFO

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_VODITEL_INFO" ( VODITEL_ID1 int )
...
prompt FUNCTION RRL_TT_VOLUME

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_VOLUME" ( IDTT int )
 RETURN number IS 
tmpVar number;
...
prompt FUNCTION RRL_TT_WEIGHT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_WEIGHT" ( IDTT int )
 RETURN number IS 
tmpVar number;
...
prompt FUNCTION RRL_TT_ZONE_DISTANCE_TO_DOCK

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_ZONE_DISTANCE_TO_DOCK" RRL_TT_ZONE_DISTANCE_TO_DOCK
...
prompt FUNCTION RRL_TT_ZONE_EMPTY

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_ZONE_EMPTY" RRL_TT_ZONE_EMPTY
(  
  time1      timestamp, 
  SUB_ZONE1  VARCHAR2
)
...
prompt FUNCTION RRL_TT_ZONE_FIND_EMPTY_DOCK

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_ZONE_FIND_EMPTY_DOCK" RRL_TT_ZONE_FIND_EMPTY_DOCK
(  
  time1      timestamp, 
  ware_id1 int
)
...
prompt FUNCTION RRL_TT_ZONE_FIND_EMPTY_PLACE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_ZONE_FIND_EMPTY_PLACE" RRL_TT_ZONE_FIND_EMPTY_PLACE
(  
  time1      timestamp, 
  ZONE1  VARCHAR2
)
...
prompt FUNCTION RRL_TT_ZONE_IS_EMPTY_DOCK

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_TT_ZONE_IS_EMPTY_DOCK" RRL_TT_ZONE_IS_EMPTY_DOCK
(  
    DOCK1 varchar2 ,  
    time1      timestamp 
)
...
prompt FUNCTION RRL_UPDATE_ARTICUL_EX

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_UPDATE_ARTICUL_EX" (
...
prompt FUNCTION RRL_UPDATE_CELL

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_UPDATE_CELL" (
cell4 varchar2 ,
X1 int ,
Y1 int ,
Z1 int , 
...
prompt FUNCTION RRL_UPDATE_OTHOD_PALLET_ROWS2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_UPDATE_OTHOD_PALLET_ROWS2" (
...
prompt FUNCTION RRL_UPDATE_PALLET_ROW

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_UPDATE_PALLET_ROW" ( 
    articul1 varchar2 ,
    pallet_uid1 varchar2 ,
    count1  number , 
    user_id1 varchar2 
...
prompt FUNCTION RRL_UPDATE_PALLET_ROW2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_UPDATE_PALLET_ROW2" ( 
    articul1 varchar2 ,
    pallet_uid1 varchar2 ,
    count1  number , 
    user_id1 varchar2
...
prompt FUNCTION RRL_UPDATE_PALLET_ROW3

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_UPDATE_PALLET_ROW3" (
    row_id1 int ,
    articul1 varchar2 ,
    pallet_uid1 varchar2 , 
...
prompt FUNCTION RRL_UPDATE_PRICE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_UPDATE_PRICE" ( tt_id int )
 RETURN number IS 
tmpVar number;
BEGIN
 tmpVar := 0;
...
prompt FUNCTION RRL_UPDATE_SBORKA_PALLET_ROWS2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_UPDATE_SBORKA_PALLET_ROWS2" (
...
prompt FUNCTION RRL_UPDATE_SG

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_UPDATE_SG" RRL_UPDATE_SG
(
    articul1 varchar2 ,
   sg int
)
...
prompt FUNCTION RRL_UPDATE_TT_ZONE

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_UPDATE_TT_ZONE" RRL_UPDATE_TT_ZONE
(  
  ZONE1      VARCHAR2, 
  SUB_ZONE1  VARCHAR2, 
  DOCK1      VARCHAR2 ,  
...
prompt FUNCTION RRL_VEHICLE_REIS_COUNT

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."RRL_VEHICLE_REIS_COUNT" ( NUM varchar2 , dat Date )
 RETURN int IS 
 varTMP int;
BEGIN
varTMP:=0;
...
prompt FUNCTION UPDATE_RRL_MOD

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."UPDATE_RRL_MOD" (
...
prompt FUNCTION UPDATE_RRL_MOD2

  CREATE OR REPLACE EDITIONABLE FUNCTION "RABAEV"."UPDATE_RRL_MOD2" (
