...
prompt PROCEDURE ADD_SFERA_EAN

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RABAEV"."ADD_SFERA_EAN" (
    row_uid out number,
    TMC_UID in varchar2,
    EAN_SHT varchar2,
    EAN_BL varchar2,
...
prompt PROCEDURE RRL_ACCEPT_ORDER2

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RABAEV"."RRL_ACCEPT_ORDER2" (
 order_id int 
 )
as
tmpVar NUMBER;
...
prompt PROCEDURE RRL_ACCEPT_ORDER2_2

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RABAEV"."RRL_ACCEPT_ORDER2_2" (
 order_id int ,
 user_id1 varchar2
 )
as
...
prompt PROCEDURE RRL_ACCEPT_ORDER3

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RABAEV"."RRL_ACCEPT_ORDER3" (
 order_id int ,
 user_id1 varchar2
 )
as
...
prompt PROCEDURE RRL_OTKAT_ORDER2

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RABAEV"."RRL_OTKAT_ORDER2" (
 order_id int 
 )
as
...
prompt PROCEDURE RRL_STORNO_ORDER3

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RABAEV"."RRL_STORNO_ORDER3" (
 order_id int ,
 user_id1 varchar2
 )
as
